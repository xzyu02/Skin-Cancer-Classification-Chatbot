...
def cnn_model():
    ...
    model.add(Conv2D(filters=6,kernel_size=(5,5),input_shape = (28, 28, 3), padding='valid', activation = 'relu'))
...
model.save('lenet5cnn.h5')
import joblib
joblib.dump(training.history, 'history_lenet5')
